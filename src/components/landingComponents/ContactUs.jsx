...
const ContactUs = () => {
  const navigate = useNavigate();
    const { register, handleSubmit, reset, formState: { errors } } = useForm({
      ...
      const contactUser = async (data) => {
        const response = await axios.post('https://quirex-real-estate-website-backend.vercel.app/api/contact-us', data);
  ...
  return (
   <>
     <NavBar/>
     <div className="container my-5" data-aos="zoom-in" data-aos-duration="400">
                     ...
                     <div className="row g-3">
                       ...
                       <div className="col-md-6">
                         ...
                         <div className="input-group">
                           ...
                           <input type="text" className="form-control" placeholder="Enter phone number" {...register('contact')}/>
                         </div>
                       ...
                       <div className="text-center mt-4">
                         <button type="submit" className="btn  px-5 btn-login">Send Message</button>
                       </div>
                     </div>
                   </form>
                 </div>
