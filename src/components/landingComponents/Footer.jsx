    ...
    <div className="row g-4">
      ...
      <div className="col-12 col-md-6 col-lg-3 mt-3">
        <div className="d-flex align-items-center mb-3 logo">
          <OtherHousesOutlinedIcon sx={{ fontSize: 50}}/> &nbsp;<b className='font text-center'>Quirex</b>
        </div>
        <p>Lorem Ipsum is simply dummy text of the and typesetting industry. Lorem Ipsum is dummy <br />text of the printing.</p>
